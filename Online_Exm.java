...
{  
    ...
    {  
        ...
        if(current==1)  
        {  
            l.setText("Que2: Which one of the following is not a keyword in java?");  
            jb[0].setText("Static");jb[1].setText("Boolean");jb[2].setText("Void");jb[3].setText("Private");  
        }  
        if(current==2)  
        {  
            l.setText("Que3: What is size of long variable?");  
            jb[0].setText("8 bit");jb[1].setText("16 bit");jb[2].setText("32 bit");jb[3].setText("64 bit");  
        }  
        if(current==3)  
        {  
            l.setText("Que4: What is the size of float variable?");  
            jb[0].setText("8 bit");jb[1].setText("16 bit");jb[2].setText("32 bit");jb[3].setText("64 bit");  
        }  
        if(current==4)  
        {  
            l.setText("Que5: Arrays in java are?");  
            jb[0].setText("object reference");jb[1].setText("objects");jb[2].setText("primitive data type");jb[3].setText("none");  
        }  
        if(current==5)  
        {  
            l.setText("Que6: Number of primitive data types in java are?");  
        ...
        {  
            ...
            jb[0].setText("JRE");jb[1].setText("JIT");jb[2].setText("JDK");jb[3].setText("None");  
        }  
        if(current==7)  
        {  
        ...
        if(current==9)  
        {  
            l.setText("Que10: Which of these are selection statements in java?");  
...
{  
    ...
    {  
        ...
        {  
            ...
            form.setBounds(400,300,500,150);  
